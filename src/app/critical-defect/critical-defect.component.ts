...
@Component({
  selector: 'app-critical-defect',
  templateUrl: './critical-defect.component.html',
  styleUrls: ['./critical-defect.component.css']
})
export class CriticalDefectComponent implements OnInit, AfterViewInit {
  ...
  getCriticalFuntionalHSDESDetails: any;
  platform: any;
  ...
  ngOnInit(): void {
    ...
    this.apiService.getCriticalDefectVector(this.payload).subscribe((res: any) => {
  ...
  apiCall() {
    this.apiService.getCriticalFunctionalDefectsHSDESResult(this.payload).subscribe((res: any) => {
      this.getCriticalFuntionalHSDESDetails = res.getFuntionalHSDESDetails;
      console.log(this.getCriticalFuntionalHSDESDetails);
      this.dataSource.data = this.getCriticalFuntionalHSDESDetails;
      this.OriginalData = this.getCriticalFuntionalHSDESDetails
      this.masterToggle()
    })
  }
