...
@Component({
  selector: 'app-high-qrc',
  templateUrl: './high-qrc.component.html',
  styleUrls: ['./high-qrc.component.css']
})
export class HighQRCComponent implements OnInit, AfterViewInit {
  ...
  getHighQRCvectorHSDESDetails: any;
  platform: any;
  ...
  ngOnInit(): void {
    ...
    this.apiService.getHighQRCvector(this.payload).subscribe((res: any) => {
  ...
  apiCall() {
    this.apiService.getHighQRCvector(this.payload).subscribe((res: any) => {
      this.getHighQRCvectorHSDESDetails = res.getQRCVectorHSDESInfo;
      console.log(this.getHighQRCvectorHSDESDetails);
      this.dataSource.data = this.getHighQRCvectorHSDESDetails;
      this.OriginalData = this.getHighQRCvectorHSDESDetails
      this.masterToggle()
    })
  }
