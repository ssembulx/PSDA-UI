...
@Component({
  selector: 'app-open-domain-debug',
  templateUrl: './open-domain-debug.component.html',
  styleUrls: ['./open-domain-debug.component.css']
})
export class OpenDomainDebugComponent implements OnInit {
  ...
  OriginalData: any;
  getDomainWiseDate: { domain: string; type: string; };
  getDomainWiseCounts = [];
  getDomainWiseHSDESInfo: any;
  selectedTarget = [];
  platform: string;
  getDomainDebugDate: { platform: any; domain: any; type: string; };
  columnFilter = {
    "status": "",
    "exposure": "",
    "domain": "",
